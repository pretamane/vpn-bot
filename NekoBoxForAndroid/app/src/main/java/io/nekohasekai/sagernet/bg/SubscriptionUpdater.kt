...
object SubscriptionUpdater {
    ...
    suspend fun reconfigureUpdater() {
        ...
        var minDelay =
                subscriptions.minByOrNull { it.subscription!!.autoUpdateDelay }!!.subscription!!
                        .autoUpdateDelay.toLong()
    ...
    class UpdateTask(appContext: Context, params: WorkerParameters) :
        ...
        override suspend fun doWork(): Result {
            ...
            if (subscriptions.isNotEmpty())
                    for (profile in subscriptions) {
                        ...
                        if (((System.currentTimeMillis() / 1000).toInt() -
                                        subscription.lastUpdated) <
                                        subscription.autoUpdateDelay * 60
                        ) {
